    ...
    return (
        <div className="flex flex-col md:flex-row justify-between md:my-20">
            <div className="flex flex-row md:ml-24">
                ...
                <div>
                    <h1 className="text-5xl mt-20 md:mt-28 ml-2">Start your <br /> Day <span className="text-[hsl(202,50%,45%)]">Free</span> Trial</h1>
                    <p className="text-sm text-[#9c9c9c]">Free 7-day trial | No credit card required</p>
                </div>
            </div>
            <div className="flex flex-col md:flex-row mt-8  md:mt-36 gap-5">
                <HoverBorderGradient
